...
export const sync = ([dvp1, dots1]: DCC, [dvp2, dots2]: DCC): DCC => {
	...
	const dvp1Dots = ol<Dot>(...dvp1.toArray(([dot]) => dot));
...
export const addDCC = ([someDvp, dccDot]: DCC, dot: Dot, value: string): DCC => dcc(
...
export const discard = ([dvps, ccDots]: DCC, dot: VV): DCC => dcc(
